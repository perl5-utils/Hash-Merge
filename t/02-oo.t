...
ok( $merge->get_behavior() eq 'LEFT_PRECEDENT',
    'no arg default is LEFT_PRECEDENT'
);
...
is_deeply(
    $lp{as},
    [ 'l1', 'l2', 'right' ],
    'Left Precedent - Array on Scalar'
);
is_deeply(
    $lp{aa},
    [ 'l1', 'l2', 'r1', 'r2' ],
    'Left Precedent - Array on Array'
);
...
ok( $merge->set_behavior('RIGHT_PRECEDENT') eq 'LEFT_PRECEDENT',
    'set_behavior() returns previous behavior' );
ok( $merge->get_behavior() eq 'RIGHT_PRECEDENT',
    'set_behavior() actually sets the behavior)'
);
...
is_deeply(
    $rp{sa},
    [ 'left', 'r1', 'r2' ],
    'Right Precedent - Scalar on Array'
);
...
is_deeply(
    $rp{aa},
    [ 'l1', 'l2', 'r1', 'r2' ],
    'Right Precedent - Array on Array'
);
...
ok( $merge->get_behavior() eq 'RIGHT_PRECEDENT',
    '"global" function does not affect object'
);
...
is_deeply(
    $sp{sa},
    [ 'left', 'r1', 'r2' ],
    'Storage Precedent - Scalar on Array'
);
is_deeply( $sp{sh}, { right => 1 }, 'Storage Precedent - Scalar on Hash' );
is_deeply(
    $sp{as},
    [ 'l1', 'l2', 'right' ],
    'Storage Precedent - Array on Scalar'
);
is_deeply(
    $sp{aa},
    [ 'l1', 'l2', 'r1', 'r2' ],
    'Storage Precedent - Array on Array'
);
...
is_deeply(
    $rep{ss},
    [ 'left', 'right' ],
    'Retainment Precedent - Scalar on Scalar'
);
is_deeply(
    $rep{sa},
    [ 'left', 'r1', 'r2' ],
    'Retainment Precedent - Scalar on Array'
);
is_deeply(
    $rep{sh},
    { left => 'left', right => 1 },
...
is_deeply(
    $rep{as},
    [ 'l1', 'l2', 'right' ],
    'Retainment Precedent - Array on Scalar'
);
is_deeply(
    $rep{aa},
    [ 'l1', 'l2', 'r1', 'r2' ],
    'Retainment Precedent - Array on Array'
);
is_deeply(
    $rep{ah},
    { l1 => 'l1', l2 => 'l2', right => 1 },
